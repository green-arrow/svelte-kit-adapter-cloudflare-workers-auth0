...
export default function (options) {
  return {
    ...
    async adapt({ utils }) {
      ...
      utils.copy(
        `${files}/entry.js`,
        '.svelte-kit/cloudflare-workers-auth0/entry.js'
      );
      utils.copy(
        `${files}/auth0.js`,
        '.svelte-kit/cloudflare-workers-auth0/auth0.js'
      );
      fs.writeFileSync(
        '.svelte-kit/cloudflare-workers-auth0/runtime.js',
        `export const protectedRoutes = ${JSON.stringify(
      ...
      const default_options = {
        entryPoints: ['.svelte-kit/cloudflare-workers-auth0/entry.js'],
